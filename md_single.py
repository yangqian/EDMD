...
def simulate_dt(options, particles, time):
    ...
    time_end=time
    time_next=time+dt
    while time_end<time_next:
        particles, time_end=simulate(options,particles,time_end)
    return particles,time_end
